...
public class ExternalResourceIT {
    ...
    static final DefaultService keycloak = new DefaultService()
    ...
    static RestService secured = new RestService()
            ...
            .withProperty("quarkus.oidc.token.issuer", "any")
    ...
    public static void setup() {
        authzClient = AuthzClient.create(
                new Configuration(getKeycloakUrl(), REALM, CLIENT_ID, Collections.singletonMap("secret", CLIENT_SECRET),
    ...
    public void testSecuredEndpointWithValidToken() {
        secured.given()
                ...
                .body(equalTo(SAMPLES_DEFAULT_REST_PATH_OUTPUT));
    }
