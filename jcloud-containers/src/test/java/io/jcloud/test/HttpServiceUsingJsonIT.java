...
import static io.jcloud.test.samples.ContainerSamples.QUARKUS_JSON_IMAGE;
import static io.jcloud.test.samples.ContainerSamples.QUARKUS_STARTUP_EXPECTED_LOG;
import static io.jcloud.test.samples.ContainerSamples.SAMPLES_DEFAULT_JSON_PATH;
import static io.jcloud.test.samples.ContainerSamples.SAMPLES_DEFAULT_JSON_PATH_OUTPUT;
