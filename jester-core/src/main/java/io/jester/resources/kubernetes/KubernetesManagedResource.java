package io.jester.resources.kubernetes;
...
import io.jester.configuration.KubernetesServiceConfiguration;
import io.jester.configuration.KubernetesServiceConfigurationBuilder;
...
import io.jester.logging.KubernetesLoggingHandler;
...
public abstract class KubernetesManagedResource extends ManagedResource {
    ...
    protected void init(ServiceContext context) {
        super.init(context);
        context.loadCustomConfiguration(io.jester.configuration.KubernetesServiceConfiguration.class,
