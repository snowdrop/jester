...
public final class KubernetesConfigurationBuilder
        extends BaseConfigurationBuilder<io.jester.api.RunOnKubernetes, KubernetesConfiguration> {
    ...
    @Override
    protected Optional<io.jester.api.RunOnKubernetes> getAnnotationConfig(String serviceName, JesterContext context) {
        return context.getAnnotatedConfiguration(io.jester.api.RunOnKubernetes.class);
    }
}
