...
public final class OpenShiftServiceConfigurationBuilder extends
        BaseConfigurationBuilder<io.github.jester.api.OpenShiftServiceConfiguration, OpenShiftServiceConfiguration> {
    ...
    @Override
    protected Optional<io.github.jester.api.OpenShiftServiceConfiguration> getAnnotationConfig(String serviceName,
            JesterContext context) {
        return context.getAnnotatedConfiguration(io.github.jester.api.OpenShiftServiceConfiguration.class,
