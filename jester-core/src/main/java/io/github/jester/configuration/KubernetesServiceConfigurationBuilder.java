...
public final class KubernetesServiceConfigurationBuilder extends
        BaseConfigurationBuilder<io.github.jester.api.KubernetesServiceConfiguration, KubernetesServiceConfiguration> {
    ...
    @Override
    protected Optional<io.github.jester.api.KubernetesServiceConfiguration> getAnnotationConfig(String serviceName,
            JesterContext context) {
        return context.getAnnotatedConfiguration(io.github.jester.api.KubernetesServiceConfiguration.class,
