...
public class ServiceConfigurationBuilder
        extends BaseConfigurationBuilder<io.github.jester.api.ServiceConfiguration, ServiceConfiguration> {
    ...
    @Override
    protected Optional<io.github.jester.api.ServiceConfiguration> getAnnotationConfig(String serviceName,
            JesterContext context) {
        return context.getAnnotatedConfiguration(io.github.jester.api.ServiceConfiguration.class,
