...
import io.github.snowdrop.jester.api.PortResolutionStrategy;
import io.github.snowdrop.jester.core.JesterContext;

public class ServiceConfigurationBuilder
        extends BaseConfigurationBuilder<io.github.snowdrop.jester.api.ServiceConfiguration, ServiceConfiguration> {
    ...
    @Override
    protected Optional<io.github.snowdrop.jester.api.ServiceConfiguration> getAnnotationConfig(String serviceName,
            JesterContext context) {
        return context.getAnnotatedConfiguration(io.github.snowdrop.jester.api.ServiceConfiguration.class,
