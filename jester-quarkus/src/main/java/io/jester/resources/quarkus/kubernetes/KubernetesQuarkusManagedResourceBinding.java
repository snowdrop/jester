...
public class KubernetesQuarkusManagedResourceBinding implements QuarkusManagedResourceBinding {
    ...
    public ManagedResource init(Quarkus metadata) {
        return new ContainerRegistryProdModeBootstrapQuarkusManagedResource(metadata.location(),
                metadata.buildCommands(), metadata.classes(), metadata.dependencies(), metadata.forceBuild());
    }
}
